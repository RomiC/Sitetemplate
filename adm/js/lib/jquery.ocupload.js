...
(function($){
	...
	$.ocupload = function(element, options) {
		...
		var container = element.parent().css({
			...
			overflow: "hidden",
			cursor: 'pointer',
			margin: parseInt(element.css("margin-top")) +"px "+ parseInt(element.css("margin-right")) +"px "+ parseInt(element.css("margin-bottom")) +"px "+ parseInt(element.css("margin-left")) +"px ",
			padding: '1px'
		});
			
		/** Put our file input in the right place */
		input.css('marginTop', '-10px');
